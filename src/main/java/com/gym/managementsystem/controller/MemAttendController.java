...
public class MemAttendController {
    ...
    @RequestMapping(value = "/members/attend", method = RequestMethod.GET)
    public List<MemberAttend> list() {
        log.info("employees Available, No of Records: " + service.listAll().size());
        return service.listAll();
    }

    @RequestMapping(value = "/members/attend/{attentdId}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/members/attend/add", method = RequestMethod.POST)
    public void add(@RequestBody MemberAttend employeeattend) {
        log.info("New employee Added");
        service.save(employeeattend);
    }

    @RequestMapping(value = "/members/attend/{attentdId}", method = RequestMethod.PUT)
    ...
    @RequestMapping(value = "/members/attend/{attentdId}", method = RequestMethod.DELETE)
